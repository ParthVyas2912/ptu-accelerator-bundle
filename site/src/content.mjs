...
export const glossary = [
  ['Accelerator', 'A starting point: code, templates and instructions you adapt in your environment. Deploy with your team or arrange assistance. Source availability does not include an operating service; delivery and support responsibilities must be agreed.'],
...
export const candidates = [
  ...
  },
  {
    ...
    next: 'Arrange private package access, confirm language and framework coverage, then evaluate code-to-spec, knowledge-graph accuracy and spec-to-code changes on one permitted module.',
  },
  {
...
export const roadmap = [
  {
    ...
    evaluation: 'Start with one document type and permitted references. Compare drafting and review time, unsupported statements and reviewer acceptance with the current process.',
    related: 1,
    gap: 'Knowledge retrieval may provide a foundation; template-based drafting and approval controls need separate development. The marketing Content Generation package is not this workflow.',
  ...
  },
  {
    ...
    evaluation: 'Use one bounded change with known impacts. Have engineers check missed impacts, false positives and time spent reviewing the suggestions.',
    related: 3,
    gap: 'SpecSuite is a related code-and-specification concept, not a verified change-impact implementation. Private package access and supported inputs must be confirmed.',
  ...
  },
  {
    ...
    evaluation: 'Use a small set of paired policies with reviewer-confirmed differences. Measure missed material differences, false alarms and review effort.',
    related: 1,
    gap: 'Document retrieval can support access to sources; bilingual alignment and meaning comparison require custom development and specialist evaluation.',
  ...
  },
  {
    ...
    evaluation: 'Start with one review and an agreed evidence checklist. Measure unsupported claims, missed gaps, traceability and preparation time.',
    related: 6,
    gap: 'Content Processing may support intake and extraction; the evidence model, review workflow and disclosure controls still need to be built.',
  ...
  },
  {
    ...
    evaluation: 'Begin with one low-risk incident category and read-only guidance. Measure correct escalation, unsafe suggestions and time to a useful next step.',
    related: 15,
    gap: 'Employee Self-Service is a related assistance starting point, not this runbook workflow. Its Copilot Studio path does not imply use of your Azure OpenAI PTUs.',
